...
class Maps:
    def __init__(self, i, j, color=(255,0,0)):
        ...
        self.current_path = []
        self.is_alive = True
        self.image = pygame.image.load("images/maps.png").convert_alpha()
    ...
    def draw_objet(self, surface, cell_size):
        x = self.i * cell_size
        y = self.j * cell_size
        surface.blit(self.image, (x + cell_size//2 - 18, y + cell_size//2 - 18))
    ...
    def draw_path(self, surface, cell_size):
        for position in self.current_path:
            ...
            pygame.draw.circle(surface, self.color, (x + cell_size//2, y + cell_size//2), 2)
